...
<head>
    ...
    <title>Registrasi Akun | Sistem Inventaris</title>
...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="#"><b>Sistem</b> Inventaris</a>
        </div>

        <div class="card shadow">
            <div class="card-body register-card-body rounded">
                <p class="login-box-msg">Daftar Akun Baru (User)</p>
                ...
                <form action="{{ route('register_proses') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-info btn-block shadow-sm">Daftar Sekarang</button>
                        </div>
                    </div>
                </form>

                <div class="text-center mt-3">
                    <a href="{{ route('login') }}" class="text-center text-info">Sudah punya akun? Log in di sini</a>
                </div>
            </div>
        </div>
    </div>
